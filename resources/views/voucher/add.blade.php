                    ...
                    <div class="row mt-5">
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" aria-describedby="title" placeholder="Enter voucher...">
                                @error('title')
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="amount" name="amount" aria-describedby="amount" placeholder="Enter amount...">
                                @error('amount')
